...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @forelse($posts as $post)
            ...
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
               <a href="{{route('post.show',$post->slug)}}"> {{\Illuminate\Support\Str::limit($post->title,50)}}</a>
            </th>
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4">
                <a href="{{route('post.edit',$post->slug)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
    ...
    <nav class="flex items-center justify-between py-4 px-2 w-full" aria-label="Table navigation">
        {{ $posts->links() }}
    </nav>
</div>
